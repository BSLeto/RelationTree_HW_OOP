public class Link {
    ...
    public String toString() {
       return String.format("%s is %s for %s", this.people1.getFirstName()+" "+this.people1.getSurName(), this.relationType, this.people2.getFirstName()+" "+this.people2.getSurName());
    }
}
